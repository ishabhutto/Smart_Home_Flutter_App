...
### 2. Profile Page & Home Page (Initial View)
<div style="display: flex; justify-content: space-between;">
...
### 3. Add New Device Screen & Add Device Screen (Filled Form)
<div style="display: flex; justify-content: space-between;">
...
### 4. Device List after Adding New Device & Device Deletion Confirmation
<div style="display: flex; justify-content: space-between;">
...
### 5. Notification when Device Status is Turned Off & Notification when Device Status is Turned On
<div style="display: flex; justify-content: space-between;">
...
### 6. Energy Consumption Pie Chart (Device Overview) & Energy Consumption Pie Chart (Usage Distribution)
<div style="display: flex; justify-content: space-between;">
...
### 7. Voltage Alert Notification & Energy Consumption Line Chart
<div style="display: flex; justify-content: space-between;">
